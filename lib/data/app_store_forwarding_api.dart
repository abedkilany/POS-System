...
mixin _AppStoreForwardingApi on ChangeNotifier, _AppStoreStateAccessors {
  Future<T> _traceAsync<T>(
    ...
    Map<String, Object?> metadata = const <String, Object?>{},
      ...
      _AppStoreSplitCoreLoading(this as AppStore)
          ._traceAsync(section, phase, action, metadata: metadata);
  ...
  void _traceSync(
    ...
    Map<String, Object?> metadata = const <String, Object?>{},
      ...
      _AppStoreSplitCoreLoading(this as AppStore)
          ._traceSync(section, phase, action, metadata: metadata);
  ...
  T _traceSyncResult<T>(
    ...
    Map<String, Object?> metadata = const <String, Object?>{},
      ...
      _AppStoreSplitCoreLoading(this as AppStore)
          ._traceSyncResult(section, phase, action, metadata: metadata);

  Future<void> warmDeferredPageCaches() =>
      _AppStoreSplitCoreLoading(this as AppStore).warmDeferredPageCaches();

  Future<void> _requestSyncDataLoad() =>
      _AppStoreSplitCoreLoading(this as AppStore)._requestSyncDataLoad();
  ...
  Future<void> _loadDeferredGroup<T>({
    ...
    void Function()? afterLoad,
      ...
      _AppStoreSplitCoreLoading(this as AppStore)._loadDeferredGroup(
          key: key, loader: loader, target: target, afterLoad: afterLoad);

  Future<void> ensureProductPricingLoaded() =>
      _AppStoreSplitCoreLoading(this as AppStore).ensureProductPricingLoaded();

  Future<void> ensureProductCostingDataLoaded() =>
      _AppStoreSplitCoreLoading(this as AppStore)
          .ensureProductCostingDataLoaded();

  Future<void> ensureSalesPageDataLoaded() =>
      _AppStoreSplitCoreLoading(this as AppStore).ensureSalesPageDataLoaded();

  Future<void> ensurePurchasesPageDataLoaded() =>
      _AppStoreSplitCoreLoading(this as AppStore)
          .ensurePurchasesPageDataLoaded();

  Future<void> ensureAccountingPageDataLoaded() =>
      _AppStoreSplitCoreLoading(this as AppStore)
          .ensureAccountingPageDataLoaded();

  Future<void> ensureQuotationsPageDataLoaded() =>
      _AppStoreSplitCoreLoading(this as AppStore)
          .ensureQuotationsPageDataLoaded();

  Future<void> ensureDeliveryNotesPageDataLoaded() =>
      _AppStoreSplitCoreLoading(this as AppStore)
          .ensureDeliveryNotesPageDataLoaded();

  Future<void> ensureInventoryPageDataLoaded() =>
      _AppStoreSplitCoreLoading(this as AppStore)
          .ensureInventoryPageDataLoaded();

  Future<void> ensureHeavyDataLoaded({bool failOnError = false}) =>
      _AppStoreSplitCoreLoading(this as AppStore)
          .ensureHeavyDataLoaded(failOnError: failOnError);

  List<Sale> get sales => _AppStoreSplitCoreLoading(this as AppStore).sales;

  Future<void> ensureCreditNotesLoaded() =>
      _AppStoreSplitCoreLoading(this as AppStore).ensureCreditNotesLoaded();
  ...
  Future<CreditNote> issueCreditNote({
    ...
    String note = '',
      ...
      _AppStoreSplitCoreLoading(this as AppStore).issueCreditNote(
  ...
  List<DeliveryNote> get deliveryNotes =>
      _AppStoreSplitCoreLoading(this as AppStore).deliveryNotes;

  List<BillOfMaterials> get billsOfMaterials =>
      _AppStoreSplitCoreLoading(this as AppStore).billsOfMaterials;

  List<ManufacturingOrder> get manufacturingOrders =>
      _AppStoreSplitCoreLoading(this as AppStore).manufacturingOrders;

  ProductCost productCostFor(String productId) =>
      _AppStoreSplitCoreLoading(this as AppStore).productCostFor(productId);
  ...
  PriceList get defaultPriceList =>
      _AppStoreSplitCoreLoading(this as AppStore).defaultPriceList;

  ProductPrice? defaultProductPriceFor(String productId,
          {String unitId = 'base'}) =>
      _AppStoreSplitCoreLoading(this as AppStore)
          .defaultProductPriceFor(productId, unitId: unitId);

  ProductPrice? productPriceFor(String productId, String priceListId,
          {String unitId = 'base'}) =>
      _AppStoreSplitCoreLoading(this as AppStore)
          .productPriceFor(productId, priceListId, unitId: unitId);

  ProductPriceOverride? productPriceOverrideFor(
          ProductPrice price, String currencyCode) =>
      _AppStoreSplitCoreLoading(this as AppStore)
          .productPriceOverrideFor(price, currencyCode);

  double productPriceAmountForCurrency(Product product, String currencyCode,
          {String unitId = 'base'}) =>
      _AppStoreSplitCoreLoading(this as AppStore)
          .productPriceAmountForCurrency(product, currencyCode, unitId: unitId);

  double defaultProductUsdPrice(Product product, {String unitId = 'base'}) =>
      _AppStoreSplitCoreLoading(this as AppStore)
          .defaultProductUsdPrice(product, unitId: unitId);

  List<DataConflict> get dataConflicts =>
      _AppStoreSplitCoreLoading(this as AppStore).dataConflicts;

  Future<List<DataConflict>> ensureDataConflictsLoaded() =>
      _AppStoreSplitCoreLoading(this as AppStore).ensureDataConflictsLoaded();

  List<Expense> get expenses =>
      _AppStoreSplitCoreLoading(this as AppStore).expenses;

  List<Purchase> get purchases =>
      _AppStoreSplitCoreLoading(this as AppStore).purchases;

  List<StockMovement> get stockMovements =>
      _AppStoreSplitCoreLoading(this as AppStore).stockMovements;
  List<InventoryCountSession> get inventoryCountSessions =>
      _AppStoreSplitCoreLoading(this as AppStore).inventoryCountSessions;

  InventoryCountSession? get activeInventoryCountSession =>
      _AppStoreSplitCoreLoading(this as AppStore).activeInventoryCountSession;

  List<Warehouse> get warehouses =>
      _AppStoreSplitCoreLoading(this as AppStore).warehouses;

  Warehouse get defaultWarehouse =>
      _AppStoreSplitCoreLoading(this as AppStore).defaultWarehouse;

  Warehouse resolveWarehouseForSale({String warehouseId = ''}) =>
      _AppStoreSplitCoreLoading(this as AppStore)
          .resolveWarehouseForSale(warehouseId: warehouseId);

  String get saleWarehouseId =>
      _AppStoreSplitCoreLoading(this as AppStore).saleWarehouseId;

  Future<void> setSaleWarehouseId(String warehouseId) =>
      _AppStoreSplitCoreLoading(this as AppStore)
  ...
  void _ensureDefaultWarehouse() =>
      _AppStoreSplitCoreLoading(this as AppStore)._ensureDefaultWarehouse();
  ...
  double stockForWarehouse(String productId, String warehouseId) =>
      _AppStoreSplitCoreLoading(this as AppStore)
          .stockForWarehouse(productId, warehouseId);
  ...
  Future<double> warehouseStockFromSqlite(
    ...
    String warehouseId = '',
      ...
      _AppStoreSplitCoreLoading(this as AppStore)
          .warehouseStockFromSqlite(productId, warehouseId: warehouseId);

  Future<Map<String, Map<String, double>>> warehouseStockBalancesFromSqlite() =>
      _AppStoreSplitCoreLoading(this as AppStore)
          .warehouseStockBalancesFromSqlite();

  Future<double> totalWarehouseStockFromSqlite(String productId) =>
      _AppStoreSplitCoreLoading(this as AppStore)
          .totalWarehouseStockFromSqlite(productId);

  Map<String, double> warehouseStockForProduct(String productId) =>
      _AppStoreSplitCoreLoading(this as AppStore)
          .warehouseStockForProduct(productId);

  List<AccountTransaction> get accountTransactions =>
      _AppStoreSplitCoreLoading(this as AppStore).accountTransactions;
  ...
  List<AccountTransaction> accountTransactionsForAccount(
    ...
    String accountId,
      ...
      _AppStoreSplitCoreLoading(this as AppStore)
          .accountTransactionsForAccount(accountType, accountId);

  double accountBalance(String accountType, String accountId) =>
      _AppStoreSplitCoreLoading(this as AppStore)
          .accountBalance(accountType, accountId);

  List<Map<String, dynamic>> databaseRows(String entity) =>
      _AppStoreSplitCoreLoading(this as AppStore).databaseRows(entity);

  Future<void> saveDatabaseRow(String entity, Map<String, dynamic> json) =>
      _AppStoreSplitCoreLoading(this as AppStore).saveDatabaseRow(entity, json);

  Future<void> deleteDatabaseRow(String entity, String id) =>
      _AppStoreSplitCoreLoading(this as AppStore).deleteDatabaseRow(entity, id);

  List<SyncChange> get syncChanges =>
      _AppStoreSplitCoreLoading(this as AppStore).syncChanges;
  List<SyncQueueItem> get syncQueue =>
      _AppStoreSplitCoreLoading(this as AppStore).syncQueue;

  List<SyncQueueItem> get pendingSyncQueue =>
      _AppStoreSplitCoreLoading(this as AppStore).pendingSyncQueue;

  List<SyncChange> get pendingSyncChanges =>
      _AppStoreSplitCoreLoading(this as AppStore).pendingSyncChanges;
  ...
  List<SyncQueueItem> pendingSyncQueueForTarget(
    ...
    bool readyOnly = true,
      ...
      _AppStoreSplitCoreLoading(this as AppStore)
          .pendingSyncQueueForTarget(target, readyOnly: readyOnly);
  ...
  List<SyncChange> pendingSyncChangesForTarget(
    ...
    bool readyOnly = true,
      ...
      _AppStoreSplitCoreLoading(this as AppStore)
          .pendingSyncChangesForTarget(target, readyOnly: readyOnly);

  List<SyncChange> submittedSyncChangesForTarget(String target) =>
      _AppStoreSplitCoreLoading(this as AppStore)
          .submittedSyncChangesForTarget(target);

  int outstandingSyncQueueCountForTarget(String target) =>
      _AppStoreSplitCoreLoading(this as AppStore)
          .outstandingSyncQueueCountForTarget(target);

  String get activeClientSyncTarget =>
      _AppStoreSplitCoreLoading(this as AppStore).activeClientSyncTarget;

  int get activeClientPendingSyncCount =>
      _AppStoreSplitCoreLoading(this as AppStore).activeClientPendingSyncCount;

  DateTime? get latestResetSyncAt =>
      _AppStoreSplitCoreLoading(this as AppStore).latestResetSyncAt;
  bool canAccessPage(String pageId) =>
      _AppStoreSplitAccessAuth(this as AppStore).canAccessPage(pageId);
  bool get hasLocalStoreData =>
      _AppStoreSplitAccessAuth(this as AppStore).hasLocalStoreData;

  Future<void> markSuspendedByHost({String reason = ''}) =>
      _AppStoreSplitAccessAuth(this as AppStore)
          .markSuspendedByHost(reason: reason);

  Future<void> clearSuspendedByHost() =>
      _AppStoreSplitAccessAuth(this as AppStore).clearSuspendedByHost();

  Future<ThemeMode> loadThemeMode() =>
      _AppStoreSplitAccessAuth(this as AppStore).loadThemeMode();

  Future<void> saveThemeMode(ThemeMode mode) =>
      _AppStoreSplitAccessAuth(this as AppStore).saveThemeMode(mode);

  Future<Locale> loadLocale() =>
      _AppStoreSplitAccessAuth(this as AppStore).loadLocale();

  Future<void> saveLocale(Locale locale) =>
      _AppStoreSplitAccessAuth(this as AppStore).saveLocale(locale);

  bool get isStressLabEnabled =>
      _AppStoreSplitAccessAuth(this as AppStore).isStressLabEnabled;

  Future<void> setStressLabEnabled(bool enabled) =>
      _AppStoreSplitAccessAuth(this as AppStore).setStressLabEnabled(enabled);

  bool get _hasOnlyLegacyDefaultAdminUser =>
      _AppStoreSplitAccessAuth(this as AppStore)._hasOnlyLegacyDefaultAdminUser;
  ...
  Future<void> completeInitialAdminSetup({
    ...
    required String password,
      ...
      _AppStoreSplitAccessAuth(this as AppStore).completeInitialAdminSetup(
  ...
  Future<void> recoverOnlineStoreOwnerIdentity({
    ...
    bool activateUser = true,
      ...
      _AppStoreSplitAccessAuth(this as AppStore)
          .recoverOnlineStoreOwnerIdentity(
              storeId: storeId,
              branchId: branchId,
              storeName: storeName,
              username: username,
  ...
  UserRole? roleById(String id) =>
      _AppStoreSplitAccessAuth(this as AppStore).roleById(id);
  ...
  void requireSensitiveActionAuthorization(String action) =>
      _AppStoreSplitAccessAuth(this as AppStore)
          .requireSensitiveActionAuthorization(action);
  bool hasPermission(String permission) =>
      _AppStoreSplitAccessAuth(this as AppStore).hasPermission(permission);
  void requirePermission(String permission) =>
      _AppStoreSplitAccessAuth(this as AppStore).requirePermission(permission);
  ...
  double get totalSalesAmount =>
      _AppStoreSplitAccessAuth(this as AppStore).totalSalesAmount;

  ExpensesOverview get expensesOverview =>
      _AppStoreSplitSupplierInsights(this as AppStore).expensesOverview;

  void _seedSupplierProductPricesFromPurchaseHistory() =>
      _AppStoreSplitSupplierInsights(this as AppStore)
    ...
    bool recordSyncChanges = false,
      ...
      _AppStoreSplitSupplierInsights(this as AppStore)
          ._seedSupplierProductPricesFromLegacyProductSuppliers(
              recordSyncChanges: recordSyncChanges);
  ...
  int supplierCountForProduct(String productId) =>
      _AppStoreSplitSupplierInsights(this as AppStore)
          .supplierCountForProduct(productId);

  List<SupplierProductPrice> supplierProductPricesForProduct(
          String productId) =>
      _AppStoreSplitSupplierInsights(this as AppStore)
          .supplierProductPricesForProduct(productId);

  List<SupplierProductPrice> supplierProductPricesForSupplier(
    String supplierId,
  ) =>
      _AppStoreSplitSupplierInsights(this as AppStore)
          .supplierProductPricesForSupplier(supplierId);

  SupplierProductPrice? supplierProductPriceFor({
    required String productId,
    required String supplierId,
  }) =>
      _AppStoreSplitSupplierInsights(this as AppStore).supplierProductPriceFor(
  ...
  SupplierProductPrice? preferredSupplierProductPriceForProduct(
    String productId,
      ...
      _AppStoreSplitSupplierInsights(this as AppStore)
          .preferredSupplierProductPriceForProduct(productId);

  SupplierProductPrice? bestPriceSupplierProductPriceForProduct(
    String productId,
  ) =>
      _AppStoreSplitSupplierInsights(this as AppStore)
          .bestPriceSupplierProductPriceForProduct(productId);

  SupplierProductPrice? fastestSupplierProductPriceForProduct(
    String productId,
  ) =>
      _AppStoreSplitSupplierInsights(this as AppStore)
          .fastestSupplierProductPriceForProduct(productId);

  Future<void> addOrUpdateSupplierProductPrice(
    SupplierProductPrice price,
  ) =>
      _AppStoreSplitSupplierInsights(this as AppStore)
          .addOrUpdateSupplierProductPrice(price);

  Future<void> deleteSupplierProductPrice(String id) =>
      _AppStoreSplitSupplierInsights(this as AppStore)
          .deleteSupplierProductPrice(id);

  Future<void> initialize({bool hydrateHeavyData = true}) =>
      _AppStoreSplitStartupMigrations(this as AppStore)
          .initialize(hydrateHeavyData: hydrateHeavyData);

  Future<List<T>> _decodeDeferredList<T>(
          String key, T Function(Map<String, dynamic>) fromJson,
          {int? batchSize}) =>
      _AppStoreSplitStartupMigrations(this as AppStore)
          ._decodeDeferredList(key, fromJson, batchSize: batchSize);
  ...
  Future<List<T>> _loadTypedEntityList<T>(
    ...
    int? batchSize,
      ...
      _AppStoreSplitStartupMigrations(this as AppStore)._loadTypedEntityList(
          key, typedLoader, fromJson,
          batchSize: batchSize);

  Future<List<StockMovement>> _loadStockMovementsForStartup() =>
      _AppStoreSplitStartupMigrations(this as AppStore)
          ._loadStockMovementsForStartup();

  Future<List<AccountTransaction>> _loadAccountTransactionsForStartup() =>
      _AppStoreSplitStartupMigrations(this as AppStore)
          ._loadAccountTransactionsForStartup();

  // ignore: unused_element
  Future<void> _loadDeferredStartupData() =>
      _AppStoreSplitStartupMigrations(this as AppStore)
          ._loadDeferredStartupData();

  // ignore: unused_element
  Future<void> _loadLedgerDeferredStartupData() =>
      _AppStoreSplitStartupMigrations(this as AppStore)
          ._loadLedgerDeferredStartupData();

  Future<void> _loadSyncDeferredStartupData() =>
      _AppStoreSplitStartupMigrations(this as AppStore)
          ._loadSyncDeferredStartupData();
  ...
  Future<void> refreshAccountTransactionsFromSqlite() =>
      _AppStoreSplitStartupMigrations(this as AppStore)
          .refreshAccountTransactionsFromSqlite();

  /// Reloads the product catalog and all pricing data used by the sales page.
  Future<void> refreshSalesProductData() =>
      _AppStoreSplitStartupMigrations(this as AppStore)
          .refreshSalesProductData();
  Future<void> refreshAfterDatabaseChange(String key) =>
      _AppStoreSplitStartupMigrations(this as AppStore)
          .refreshAfterDatabaseChange(key);

  /// Conservative full refresh used for unknown keys or recovery after a failed
  /// targeted refresh.
  Future<void> reloadAllAfterDatabaseChange() =>
      _AppStoreSplitStartupMigrations(this as AppStore)
          .reloadAllAfterDatabaseChange();

  String _generatePrefixedId(String prefix) =>
      _AppStoreSplitStartupMigrations(this as AppStore)
          ._generatePrefixedId(prefix);
  ...
  int _loadSyncSequence() =>
      _AppStoreSplitStartupMigrations(this as AppStore)._loadSyncSequence();

  int _nextSyncSequence() =>
      _AppStoreSplitStartupMigrations(this as AppStore)._nextSyncSequence();

  String _newSyncEnvelopeId(DateTime now, String prefix) =>
      _AppStoreSplitStartupMigrations(this as AppStore)
          ._newSyncEnvelopeId(now, prefix);

  Map<String, dynamic> _syncV2MetaOf(SyncChange change) =>
      _AppStoreSplitStartupMigrations(this as AppStore)._syncV2MetaOf(change);

  String _syncMetaString(SyncChange change, String key) =>
      _AppStoreSplitStartupMigrations(this as AppStore)
          ._syncMetaString(change, key);
  ...
  bool _isReplayOrDuplicateSyncEvent(
    ...
    required int lastAppliedSequence,
      ...
      _AppStoreSplitStartupMigrations(this as AppStore)
          ._isReplayOrDuplicateSyncEvent(change,
  ...
  String? validateClientDraftForHostAcceptance(SyncChange change) =>
      _AppStoreSplitStartupMigrations(this as AppStore)
          .validateClientDraftForHostAcceptance(change);

  Future<void> clearPendingSyncQueue({bool notify = true}) =>
      _AppStoreSplitStartupMigrations(this as AppStore)
          .clearPendingSyncQueue(notify: notify);

  int _loadInvoiceCounter() =>
      _AppStoreSplitStartupMigrations(this as AppStore)._loadInvoiceCounter();

  // Legacy migration path retained for controlled recovery of pre-v17 stores.
  // ignore: unused_element
  Future<void> _runDataMigrationsIfNeeded() =>
      _AppStoreSplitStartupMigrations(this as AppStore)
          ._runDataMigrationsIfNeeded();

  double _safeUsdCost(Product product) =>
      _AppStoreSplitStartupMigrations(this as AppStore)._safeUsdCost(product);

  AppPlatformType _detectPlatform() =>
      _AppStoreSplitIdentityUsers(this as AppStore)._detectPlatform();

  AppIdentity _loadOrCreateAppIdentity() =>
      _AppStoreSplitIdentityUsers(this as AppStore)._loadOrCreateAppIdentity();

  Future<void> updateDeviceName(String deviceName) =>
      _AppStoreSplitIdentityUsers(this as AppStore)
  ...
  AppIdentity _normalizedLocalIdentity(AppIdentity identity) =>
      _AppStoreSplitIdentityUsers(this as AppStore)
          ._normalizedLocalIdentity(identity);

  Map<String, dynamic>? get pendingHostTransferRequest =>
      _AppStoreSplitIdentityUsers(this as AppStore).pendingHostTransferRequest;

  Map<String, dynamic>? get latestHostTransferNotification =>
      _AppStoreSplitIdentityUsers(this as AppStore)
          .latestHostTransferNotification;

  Future<void> clearHostTransferNotification() =>
      _AppStoreSplitIdentityUsers(this as AppStore)
          .clearHostTransferNotification();

  Future<void> _storeHostTransferNotification(
    Map<String, dynamic> payload,
  ) =>
      _AppStoreSplitIdentityUsers(this as AppStore)
          ._storeHostTransferNotification(payload);

  Future<void> clearLocalHostTransferRequest() =>
      _AppStoreSplitIdentityUsers(this as AppStore)
          .clearLocalHostTransferRequest();

  Future<void> _forceApplyRoleFromTransfer(AppIdentity next) =>
      _AppStoreSplitIdentityUsers(this as AppStore)
          ._forceApplyRoleFromTransfer(next);
  ...
  void _assertSafeRoleTransition(
    ...
    bool allowInitialHostRegistration = false,
      ...
      _AppStoreSplitIdentityUsers(this as AppStore)._assertSafeRoleTransition(
          next,
          source: source,
          allowApprovedTransfer: allowApprovedTransfer,
          allowInitialHostRegistration: allowInitialHostRegistration);

  void _assertLanDirectRoleRules(AppIdentity next, {required String source}) =>
      _AppStoreSplitIdentityUsers(this as AppStore)
          ._assertLanDirectRoleRules(next, source: source);

  Future<void> updateAppIdentityDuringSetup(AppIdentity identity) =>
      _AppStoreSplitIdentityUsers(this as AppStore)
          .updateAppIdentityDuringSetup(identity);

  Future<void> updateAppIdentity(AppIdentity identity) =>
      _AppStoreSplitIdentityUsers(this as AppStore).updateAppIdentity(identity);
  ...
  Future<void> updateAppIdentityLocalOnly(
    ...
    String source = 'local sync settings',
      ...
      _AppStoreSplitIdentityUsers(this as AppStore)
          .updateAppIdentityLocalOnly(identity, source: source);

  Future<void> setActiveSyncTransport(String transport) =>
      _AppStoreSplitIdentityUsers(this as AppStore)
          .setActiveSyncTransport(transport);

  Future<void> requestHostTransfer({String reason = ''}) =>
      _AppStoreSplitIdentityUsers(this as AppStore)
          .requestHostTransfer(reason: reason);

  Future<void> approveHostTransfer(String requestingDeviceId) =>
      _AppStoreSplitIdentityUsers(this as AppStore)
          .approveHostTransfer(requestingDeviceId);

  Future<void> activateApprovedHostTransfer() =>
      _AppStoreSplitIdentityUsers(this as AppStore)
          .activateApprovedHostTransfer();

  @Deprecated('Use users and roles instead. Kept for old code compatibility.')
  Future<void> setCurrentRole(String role) =>
      _AppStoreSplitIdentityUsers(this as AppStore).setCurrentRole(role);

  Future<List<UserRole>> _loadRoles() =>
      _AppStoreSplitIdentityUsers(this as AppStore)._loadRoles();

  Future<List<AppUser>> _loadUsers() =>
      _AppStoreSplitIdentityUsers(this as AppStore)._loadUsers();

  Future<void> _saveRolesAndUsers() =>
      _AppStoreSplitIdentityUsers(this as AppStore)._saveRolesAndUsers();

  Future<void> _ensureDefaultAdminUser() =>
      _AppStoreSplitIdentityUsers(this as AppStore)._ensureDefaultAdminUser();

  void _restoreActiveUser() =>
      _AppStoreSplitIdentityUsers(this as AppStore)._restoreActiveUser();
  ...
  Future<void> logout() =>
      _AppStoreSplitIdentityUsers(this as AppStore).logout();
  ...
  Future<void> applySessionUser({
    ...
    required bool rememberLogin,
      ...
      _AppStoreSplitIdentityUsers(this as AppStore).applySessionUser(
  ...
  Future<void> clearSessionUser() =>
      _AppStoreSplitIdentityUsers(this as AppStore).clearSessionUser();

  Future<void> _loadSessionPermissionsFromStorage() =>
      _AppStoreSplitIdentityUsers(this as AppStore)
          ._loadSessionPermissionsFromStorage();

  Future<void> _restoreActiveUserFromStorage() =>
      _AppStoreSplitIdentityUsers(this as AppStore)
          ._restoreActiveUserFromStorage();

  Future<void> _refreshAuthFlags() =>
      _AppStoreSplitIdentityUsers(this as AppStore)._refreshAuthFlags();
  ...
  Future<bool> applySupportPasswordResetToLocalUser({
    ...
    required String newPassword,
      ...
      _AppStoreSplitIdentityUsers(this as AppStore)
          .applySupportPasswordResetToLocalUser(
  ...
  Future<void> addOrUpdateRole(UserRole role) =>
      _AppStoreSplitIdentityUsers(this as AppStore).addOrUpdateRole(role);

  Future<void> deleteRole(String id) =>
      _AppStoreSplitIdentityUsers(this as AppStore).deleteRole(id);

  AppUser? get storeOwnerUser =>
      _AppStoreSplitIdentityUsers(this as AppStore).storeOwnerUser;
  ...
  Future<void> applyStoreOwnerCredentials({
    ...
    String? fullName,
      ...
      _AppStoreSplitIdentityUsers(this as AppStore).applyStoreOwnerCredentials(
          username: username, password: password, fullName: fullName);

  Future<void> addOrUpdateUser(AppUser user, {String? password}) =>
      _AppStoreSplitIdentityUsers(this as AppStore)
          .addOrUpdateUser(user, password: password);

  Future<void> deleteUser(String id) =>
      _AppStoreSplitIdentityUsers(this as AppStore).deleteUser(id);

  Future<String> _hashPasswordAsync(String password) =>
      _AppStoreSplitIdentityUsers(this as AppStore)
          ._hashPasswordAsync(password);

  String _generateSalt() =>
      _AppStoreSplitIdentityUsers(this as AppStore)._generateSalt();

  StoreProfile _loadStoreProfile() =>
      _AppStoreSplitIdentityUsers(this as AppStore)._loadStoreProfile();

  void _normalizeCustomers() =>
      _AppStoreSplitIdentityUsers(this as AppStore)._normalizeCustomers();
  ...
  Future<void> _upsertSqliteBusinessRows(
    ...
    Iterable<Map<String, dynamic>> rows,
      ...
      _AppStoreSplitIdentityUsers(this as AppStore)
          ._upsertSqliteBusinessRows(key, rows);

  void _markProductDerivedDataDirty() =>
      _AppStoreSplitIdentityUsers(this as AppStore)
          ._markProductDerivedDataDirty();

  Future<void> _flushProductDerivedData() =>
      _AppStoreSplitIdentityUsers(this as AppStore)._flushProductDerivedData();

  Future<bool> _schedulePurchaseAccounting(Purchase purchase) =>
      _AppStoreSplitIdentityUsers(this as AppStore)
          ._schedulePurchaseAccounting(purchase);

  Future<void> _waitForPendingPurchaseAccounting(String purchaseId) =>
      _AppStoreSplitIdentityUsers(this as AppStore)
          ._waitForPendingPurchaseAccounting(purchaseId);

  Future<void> waitForPendingAccounting({
    Duration timeout = const Duration(seconds: 45),
  }) =>
      _AppStoreSplitIdentityUsers(this as AppStore)
          .waitForPendingAccounting(timeout: timeout);

  void _rebuildProductIndexes() =>
      _AppStoreSplitIdentityUsers(this as AppStore)._rebuildProductIndexes();

  void _rebuildCustomerIndexes() =>
      _AppStoreSplitIdentityUsers(this as AppStore)._rebuildCustomerIndexes();

  void _rebuildSupplierIndexes() =>
      _AppStoreSplitIdentityUsers(this as AppStore)._rebuildSupplierIndexes();
  ...
  Future<Purchase?> reloadPurchaseFromSqlite(String id) =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          .reloadPurchaseFromSqlite(id);

  Future<Expense?> _expenseByIdFromSqlite(String id) =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          ._expenseByIdFromSqlite(id);

  void _putStockMovementAtIndex(StockMovement movement, int index) =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          ._putStockMovementAtIndex(movement, index);
  ...
  void _touchDataRevisions({
    ...
    bool storeProfile = false,
      ...
      _AppStoreSplitPersistenceSyncCore(this as AppStore)._touchDataRevisions(
          products: products,
          customers: customers,
          sales: sales,
  ...
  void _touchPurchasesData() =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)._touchPurchasesData();

  void _touchExpensesData() =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)._touchExpensesData();

  void _putPurchaseAtIndex(Purchase purchase, int index) =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          ._putPurchaseAtIndex(purchase, index);

  void _removePurchaseAtIndex(int index) =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          ._removePurchaseAtIndex(index);

  void _putExpenseAtIndex(Expense expense, int index) =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          ._putExpenseAtIndex(expense, index);
  ...
  void _removeAccountTransactionAtIndex(int index) =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          ._removeAccountTransactionAtIndex(index);
  ...
  int _earliestStoredAuthoritativeSequence() =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          ._earliestStoredAuthoritativeSequence();
  ...
  int _minimumActivePeerAckSequence({
    Duration activeWindow = const Duration(days: 14),
      ...
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          ._minimumActivePeerAckSequence(activeWindow: activeWindow);

  Future<void> _saveSyncStateOnly() =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)._saveSyncStateOnly();

  Future<void> _saveAll() =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)._saveAll();
  ...
  Future<void> _saveDirty({
    ...
    bool sync = false,
      ...
      _AppStoreSplitPersistenceSyncCore(this as AppStore)._saveDirty(
          products: products,
  ...
  Future<void> resetBusinessData({bool keepStoreProfile = true}) =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          .resetBusinessData(keepStoreProfile: keepStoreProfile);

  Future<void> clearLocalDeviceBusinessData({
    bool keepStoreProfile = true,
  }) =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          .clearLocalDeviceBusinessData(keepStoreProfile: keepStoreProfile);

  Future<int> clearLocalOnlyPendingSyncChanges() =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          .clearLocalOnlyPendingSyncChanges();
  ...
  Future<void> factoryResetLocalDevice({
    ...
    bool preserveAdminUsers = false,
      ...
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          .factoryResetLocalDevice(
              enforcePermission: enforcePermission,
              preserveAdminUsers: preserveAdminUsers);

  Future<int> cleanupSoftDeletedRecords({
    Duration retention = const Duration(days: 30),
  }) =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          .cleanupSoftDeletedRecords(retention: retention);

  Future<BusinessDataIntegrityResult> verifyLocalBusinessDataIntegrity() =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          .verifyLocalBusinessDataIntegrity();
  ...
  Future<BusinessDataIntegrityRepairResult> repairMissingProductReferences({
    bool createArchivedProducts = false,
      ...
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          .repairMissingProductReferences(
              createArchivedProducts: createArchivedProducts);
  ...
  void _validateProduct(Product product, {Product? previousProduct}) =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          ._validateProduct(product, previousProduct: previousProduct);
  ...
  String _generateUniqueProductCode({
    ...
    Set<String>? reservedCodes,
      ...
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          ._generateUniqueProductCode(
              exceptProductId: exceptProductId, reservedCodes: reservedCodes);

  String get _invoiceDevicePrefix =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)._invoiceDevicePrefix;

  int _invoiceSequenceFromNo(String invoiceNo) =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          ._invoiceSequenceFromNo(invoiceNo);
  ...
  void _rememberSqliteDirtyBusinessRow(
    ...
    Map<String, dynamic> payload,
      ...
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          ._rememberSqliteDirtyBusinessRow(key, payload);

  void _forgetSqliteDirtyBusinessRow(String key, String id) =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          ._forgetSqliteDirtyBusinessRow(key, id);
  ...
  void _recordSyncChange({
    ...
    required Map<String, dynamic> payload,
      ...
      _AppStoreSplitPersistenceSyncCore(this as AppStore)._recordSyncChange(
  ...
  /// process crash.
  Future<void> recoverPhase8AccountingSyncAfterStartup() =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          .recoverPhase8AccountingSyncAfterStartup();

  Future<void> recordPhase8AccountingMutationForSync() =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          .recordPhase8AccountingMutationForSync();

  bool get _isLanClientConfigured =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          ._isLanClientConfigured;

  bool get _isDirectClientConfigured =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          ._isDirectClientConfigured;

  bool get _isLanHostConfigured =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)._isLanHostConfigured;

  String get _stockTransactionSyncTarget =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          ._stockTransactionSyncTarget;
  ...
  Future<void> _reconcileUnsyncedChangesWithQueue() =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          ._reconcileUnsyncedChangesWithQueue();
  ...
  Sale _saleSyncMetaPreview(
    ...
    bool isCreate = false,
      ...
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          ._saleSyncMetaPreview(item, now, isCreate: isCreate);
  ...
  Purchase _purchaseSyncMetaPreview(
    ...
    bool isCreate = false,
      ...
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          ._purchaseSyncMetaPreview(item, now, isCreate: isCreate);
  ...
  Expense _expenseSyncMetaPreview(
    ...
    bool isCreate = false,
      ...
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          ._expenseSyncMetaPreview(item, now, isCreate: isCreate);
  ...
  T _withSyncMeta<T>(
    ...
    bool clearDeletedAt = true,
      ...
      _AppStoreSplitPersistenceSyncCore(this as AppStore)._withSyncMeta(
          item, now,
          isCreate: isCreate, clearDeletedAt: clearDeletedAt);
  ...
  Future<void> _persistAccountTransactionInExistingTransaction(
    ...
    AccountTransaction transaction,
      ...
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          ._persistAccountTransactionInExistingTransaction(
  ...
  Future<void> addOrUpdateAccountTransaction(
    AccountTransaction transaction,
      ...
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          .addOrUpdateAccountTransaction(transaction);

  Future<void> deleteAccountTransaction(String id) =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          .deleteAccountTransaction(id);

  Future<void> _recordPurchaseLedger(Purchase purchase, DateTime now) =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
  ...
  Future<void> _recordPurchaseCancelLedger(
    ...
    bool isReturn = false,
      ...
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          ._recordPurchaseCancelLedger(purchase, now,
              reason: reason, isReturn: isReturn);

  Future<void> _recordSaleLedger(Sale sale, DateTime now) =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
    ...
    String returnReferenceId = '',
      ...
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          ._recordSaleCancelLedger(sale, now,
              isReturn: isReturn, returnReferenceId: returnReferenceId);

  Future<void> _reverseExpenseLedger(Expense expense, DateTime now,
          {String reason = ''}) =>
      _AppStoreSplitPersistenceSyncCore(this as AppStore)
          ._reverseExpenseLedger(expense, now, reason: reason);

  void _ensureDefaultPriceLists() =>
      _AppStoreSplitPricingCosting(this as AppStore)._ensureDefaultPriceLists();
  ...
  void _removeProductPricingLookupEntries(String productId) =>
      _AppStoreSplitPricingCosting(this as AppStore)
          ._removeProductPricingLookupEntries(productId);

  void _ensureDefaultProductPriceEntries({Product? product}) =>
      _AppStoreSplitPricingCosting(this as AppStore)
          ._ensureDefaultProductPriceEntries(product: product);
  ...
  Future<void> setDefaultProductBasePrice(
      ...
      _AppStoreSplitPricingCosting(this as AppStore).setDefaultProductBasePrice(
          productId: productId,
          unitId: unitId,
          amount: amount,
  ...
  Future<void> setProductBasePriceForList({
    ...
    String unitId = 'base',
      ...
      _AppStoreSplitPricingCosting(this as AppStore).setProductBasePriceForList(
          productId: productId,
  ...
  Future<void> setProductPriceOverride({
    ...
    bool isActive = true,
      ...
      _AppStoreSplitPricingCosting(this as AppStore).setProductPriceOverride(
  ...
  Future<void> removeProductPriceOverride(
          String productPriceId, String currencyCode) =>
      _AppStoreSplitPricingCosting(this as AppStore)
          .removeProductPriceOverride(productPriceId, currencyCode);

  void _ensureProductCostEntries({Product? product}) =>
      _AppStoreSplitPricingCosting(this as AppStore)
          ._ensureProductCostEntries(product: product);

  InventoryCostingMethod _runtimeInventoryCostingMethod(
          InventoryCostingMethod requested) =>
      _AppStoreSplitPricingCosting(this as AppStore)
          ._runtimeInventoryCostingMethod(requested);
  ...
  Future<void> setInventoryCostingMethod(InventoryCostingMethod method,
          {String reason = ''}) =>
      _AppStoreSplitPricingCosting(this as AppStore)
          .setInventoryCostingMethod(method, reason: reason);
  ...
  bool _purchaseHasConsumedCostLayers(String purchaseId) =>
      _AppStoreSplitPricingCosting(this as AppStore)
          ._purchaseHasConsumedCostLayers(purchaseId);
  ...
  Future<InventoryCostResult> _resolveCostForSaleItemInTransaction(
    ...
    DateTime now,
      ...
      _AppStoreSplitPricingCosting(this as AppStore)
          ._resolveCostForSaleItemInTransaction(db, item, now);
  ...
  Future<void> _closeInventoryCostLayersForPurchaseInTransaction(
    ...
    DateTime now,
      ...
      _AppStoreSplitPricingCosting(this as AppStore)
          ._closeInventoryCostLayersForPurchaseInTransaction(db, purchase, now);
  ...
  Future<_ManufacturingCostResolution> _consumeManufacturingCostInTransaction(
    ...
    required DateTime now,
      ...
      _AppStoreSplitPricingCosting(this as AppStore)
          ._consumeManufacturingCostInTransaction(db,
              product: product, quantity: quantity, orderId: orderId, now: now);
  ...
  void _closeInventoryCostLayersForPurchase(String purchaseId, DateTime now) =>
      _AppStoreSplitPricingCosting(this as AppStore)
          ._closeInventoryCostLayersForPurchase(purchaseId, now);

  Future<void> addOrUpdateProduct(Product product) =>
      _AppStoreSplitCatalogPartiesExpenses(this as AppStore)
          .addOrUpdateProduct(product);

  Future<void> addOrUpdateProductsBulk(List<Product> products) =>
      _AppStoreSplitCatalogPartiesExpenses(this as AppStore)
          .addOrUpdateProductsBulk(products);

  bool isProductReferenced(String productId) =>
      _AppStoreSplitCatalogPartiesExpenses(this as AppStore)
          .isProductReferenced(productId);

  Future<void> deleteProduct(String id) =>
      _AppStoreSplitCatalogPartiesExpenses(this as AppStore).deleteProduct(id);

  Future<void> addOrUpdateCustomer(Customer customer) =>
      _AppStoreSplitCatalogPartiesExpenses(this as AppStore)
          .addOrUpdateCustomer(customer);

  Future<void> addOrUpdateCustomersBulk(List<Customer> customers) =>
      _AppStoreSplitCatalogPartiesExpenses(this as AppStore)
          .addOrUpdateCustomersBulk(customers);

  Future<void> deleteCustomer(String id) =>
      _AppStoreSplitCatalogPartiesExpenses(this as AppStore).deleteCustomer(id);

  Future<void> addOrUpdateSupplier(Supplier supplier) =>
      _AppStoreSplitCatalogPartiesExpenses(this as AppStore)
          .addOrUpdateSupplier(supplier);

  Future<void> addOrUpdateSuppliersBulk(List<Supplier> suppliers) =>
      _AppStoreSplitCatalogPartiesExpenses(this as AppStore)
          .addOrUpdateSuppliersBulk(suppliers);

  Future<void> deleteSupplier(String id) =>
      _AppStoreSplitCatalogPartiesExpenses(this as AppStore).deleteSupplier(id);
  ...
  Future<void> replaceAndDeleteCatalogItem({
    ...
    CatalogItem? replacement,
      ...
      _AppStoreSplitCatalogPartiesExpenses(this as AppStore)
          .replaceAndDeleteCatalogItem(
              type: type, item: item, replacement: replacement);
  ...
  Future<void> createAndPostExpensesBulk(List<Expense> expenses) =>
      _AppStoreSplitCatalogPartiesExpenses(this as AppStore)
          .createAndPostExpensesBulk(expenses);

  Future<void> deleteDraftExpense(String id) =>
      _AppStoreSplitCatalogPartiesExpenses(this as AppStore)
          .deleteDraftExpense(id);

  Future<void> cancelExpense(String id, {String reason = ''}) =>
      _AppStoreSplitCatalogPartiesExpenses(this as AppStore)
          .cancelExpense(id, reason: reason);

  Future<void> permanentlyDeleteCancelledExpense(String id) =>
      _AppStoreSplitCatalogPartiesExpenses(this as AppStore)
          .permanentlyDeleteCancelledExpense(id);

  int _loadPurchaseCounter() =>
      _AppStoreSplitWarehouseCash(this as AppStore)._loadPurchaseCounter();
  ...
  Future<Warehouse> createWarehouse({
    ...
    String location = '',
      ...
      _AppStoreSplitWarehouseCash(this as AppStore)
          .createWarehouse(name: name, code: code, location: location);
  ...
  Future<List<WarehouseTransferOrder>> recentWarehouseTransferOrders({
    int limit = 100,
      ...
      _AppStoreSplitWarehouseCash(this as AppStore)
          .recentWarehouseTransferOrders(limit: limit);
  ...
  Future<void> transferStock({
    ...
    String notes = '',
      ...
      _AppStoreSplitWarehouseCash(this as AppStore).transferStock(
          productId: productId,
          fromWarehouseId: fromWarehouseId,
          toWarehouseId: toWarehouseId,
          quantity: quantity,
  ...
  Future<Map<String, dynamic>> verifyInventoryTraceabilityIntegrity() async {
    ...
    if (!LocalDatabaseService.isSqliteAuthoritative || sqliteDb == null) {
      throw StateError(
          'Inventory integrity verification requires SQLite storage.');
    }
  ...
  Future<double> refundableSaleCashAmount(String saleId) =>
      _AppStoreSplitWarehouseCash(this as AppStore)
          .refundableSaleCashAmount(saleId);

  Future<void> normalizeRefundAllocations() =>
      _AppStoreSplitWarehouseCash(this as AppStore)
          .normalizeRefundAllocations();

  Future<double> refundablePurchaseCashAmount(String purchaseId) =>
      _AppStoreSplitWarehouseCash(this as AppStore)
          .refundablePurchaseCashAmount(purchaseId);

  Future<double> refundablePurchaseReturnCashAmount(String purchaseReturnId) =>
      _AppStoreSplitWarehouseCash(this as AppStore)
          .refundablePurchaseReturnCashAmount(purchaseReturnId);
  ...
  Future<double> refundSaleCash({
    ...
    DateTime? date,
      ...
      _AppStoreSplitWarehouseCash(this as AppStore).refundSaleCash(
          saleId: saleId,
          amount: amount,
          notes: notes,
  ...
  Future<double> refundPurchaseCash({
    ...
    DateTime? date,
      ...
      _AppStoreSplitWarehouseCash(this as AppStore).refundPurchaseCash(
  ...
  Future<double> refundPurchaseReturnCash({
    ...
    DateTime? date,
      ...
      _AppStoreSplitWarehouseCash(this as AppStore).refundPurchaseReturnCash(
  ...
  Future<double> refundableExpenseCashAmount(String expenseId) =>
      _AppStoreSplitWarehouseCash(this as AppStore)
          .refundableExpenseCashAmount(expenseId);
  ...
  Future<double> refundExpenseCash({
    ...
    String notes = '',
      ...
      _AppStoreSplitWarehouseCash(this as AppStore).refundExpenseCash(
          expenseId: expenseId, amount: amount, notes: notes);
  ...
  Future<void> settleAccountPayment({
    ...
    DateTime? date,
      ...
      _AppStoreSplitWarehouseCash(this as AppStore).settleAccountPayment(
  ...
  PurchaseItem _copyPurchaseItemWith({
    ...
    List<BatchAllocation>? batchAllocations,
      ...
      _AppStoreSplitWarehouseCash(this as AppStore)._copyPurchaseItemWith(
          item: item, lineId: lineId, batchAllocations: batchAllocations);
  ...
  Future<double> _unifiedOpeningCostForProductInTransaction(
    ...
    required String warehouseId,
      ...
      _AppStoreSplitPurchases(this as AppStore)
          ._unifiedOpeningCostForProductInTransaction(sqliteDb,
  ...
  Future<void> _ensureUnifiedBatchCutoverForProductInTransaction(
    ...
    required DateTime at,
      ...
      _AppStoreSplitPurchases(this as AppStore)
          ._ensureUnifiedBatchCutoverForProductInTransaction(sqliteDb,
              product: product, warehouseId: warehouseId, at: at);
  ...
  Future<void> _assertUnifiedBatchMovementBalancesInTransaction(
    ...
    Iterable<StockMovement> movements,
      ...
      _AppStoreSplitPurchases(this as AppStore)
          ._assertUnifiedBatchMovementBalancesInTransaction(
  ...
  Future<Purchase> createPurchase({
    ...
    String warehouseName = '',
      ...
      _AppStoreSplitPurchases(this as AppStore).createPurchase(
          supplierId: supplierId,
          supplierName: supplierName,
          items: items,
  ...
  Future<void> receivePurchase(
    ...
    Map<int, List<BatchAllocation>> batchAllocationsByLine =
      ...
      _AppStoreSplitPurchases(this as AppStore).receivePurchase(id,
          settleInitialPayment: settleInitialPayment,
          postAccounting: postAccounting,
          batchAllocationsByLine: batchAllocationsByLine);
  ...
  Future<Purchase> createPurchaseReturn({
    ...
    String reason = '',
      ...
      _AppStoreSplitPurchases(this as AppStore).createPurchaseReturn(
        sourcePurchaseId: sourcePurchaseId,
        items: items,
        reason: reason,
      );

  Future<void> deleteDraftPurchase(String id) =>
      _AppStoreSplitPurchases(this as AppStore).deleteDraftPurchase(id);

  Future<void> permanentlyDeleteCancelledPurchase(String id) =>
      _AppStoreSplitPurchases(this as AppStore)
          .permanentlyDeleteCancelledPurchase(id);
  ...
  Future<void> _requirePostedJournalInTransaction(
    ...
    required String failureMessage,
      ...
      _AppStoreSplitPurchases(this as AppStore)
          ._requirePostedJournalInTransaction(sqliteDb,
  ...
  Future<void> _requireNoActiveJournalInTransaction(
    ...
    required String failureMessage,
      ...
      _AppStoreSplitPurchases(this as AppStore)
          ._requireNoActiveJournalInTransaction(sqliteDb,
              referenceType: referenceType,
              referenceId: referenceId,
              includePurchaseEditFamily: includePurchaseEditFamily,
              includeSaleEditFamily: includeSaleEditFamily,
  ...
  Future<void> returnPurchase(
    ...
    bool recordSupplierReturnLedger = true,
      ...
      _AppStoreSplitPurchases(this as AppStore).returnPurchase(id,
          reverseStock: reverseStock,
          reason: reason,
          recordSupplierReturnLedger: recordSupplierReturnLedger);
  ...
  Future<InventoryCountSession> createInventoryCountSession({
    ...
    String warehouseName = '',
      ...
      _AppStoreSplitInventory(this as AppStore).createInventoryCountSession(
          notes: notes, warehouseId: warehouseId, warehouseName: warehouseName);
  ...
  Future<void> countInventoryLine({
    ...
    String note = '',
      ...
      _AppStoreSplitInventory(this as AppStore).countInventoryLine(
          sessionId: sessionId,
          productId: productId,
  ...
  Future<void> resetInventoryCountLine({
    ...
    required String productId,
      ...
      _AppStoreSplitInventory(this as AppStore)
          .resetInventoryCountLine(sessionId: sessionId, productId: productId);

  Future<void> approveInventoryCount(String sessionId) =>
      _AppStoreSplitInventory(this as AppStore)
          .approveInventoryCount(sessionId);
  ...
  Future<void> reverseInventoryCount(
    ...
    String reason = '',
      ...
      _AppStoreSplitInventory(this as AppStore)
          .reverseInventoryCount(sessionId, reason: reason);

  Future<void> cancelInventoryCount(String sessionId) =>
      _AppStoreSplitInventory(this as AppStore).cancelInventoryCount(sessionId);
  ...
  Future<void> reviewAutoCorrection(
    ...
    String note = '',
      ...
      _AppStoreSplitInventory(this as AppStore)
          .reviewAutoCorrection(movementId, note: note);

  Future<void> setExpiryBatchStatus(String batchId, String status) =>
      _AppStoreSplitInventory(this as AppStore)
          .setExpiryBatchStatus(batchId, status);
  ...
  Future<void> adjustExpiryBatchStock({
    ...
    String adjustmentCategory = 'other',
      ...
      _AppStoreSplitInventory(this as AppStore).adjustExpiryBatchStock(
          productId: productId,
          warehouseId: warehouseId,
          batchId: batchId,
  ...
  Future<void> reverseExpiryBatchAdjustment(
    ...
    String reason = '',
      ...
      _AppStoreSplitInventory(this as AppStore)
          .reverseExpiryBatchAdjustment(movementId, reason: reason);
  ...
  Future<void> adjustStock({
    ...
    String operationReferenceId = '',
      ...
      _AppStoreSplitInventory(this as AppStore).adjustStock(
          productId: productId,
          warehouseId: warehouseId,
          quantityDelta: quantityDelta,
          reason: reason,
  ...
  Future<void> recordWasteLoss({
    ...
    String notes = '',
      ...
      _AppStoreSplitInventory(this as AppStore).recordWasteLoss(
          productId: productId,
          warehouseId: warehouseId,
          quantity: quantity,
          reason: reason,
  ...
  Future<void> reverseWasteLossGroup(String movementId) =>
      _AppStoreSplitInventory(this as AppStore)
          .reverseWasteLossGroup(movementId);

  Future<void> deleteWasteLoss(String movementId) =>
      _AppStoreSplitInventory(this as AppStore).deleteWasteLoss(movementId);
  ...
  void _addStockMovement(StockMovement movement, {bool recordSync = false}) =>
      _AppStoreSplitInventory(this as AppStore)
          ._addStockMovement(movement, recordSync: recordSync);
  ...
  Future<void> _reconcileInventoryAccountsAfterBomChange(
    ...
    bool withinExistingTransaction = false,
      ...
      _AppStoreSplitInventory(this as AppStore)
          ._reconcileInventoryAccountsAfterBomChange(bom,
              database: database,
  ...
  Future<BillOfMaterials> createBillOfMaterials({
    ...
    String notes = '',
      ...
      _AppStoreSplitManufacturing(this as AppStore).createBillOfMaterials(
          name: name,
  ...
  Future<BillOfMaterials> updateBillOfMaterials({
    ...
    String notes = '',
      ...
      _AppStoreSplitManufacturing(this as AppStore).updateBillOfMaterials(
          id: id,
          name: name,
          outputProductId: outputProductId,
          outputQuantity: outputQuantity,
  ...
  Future<void> deleteBillOfMaterials(String id) =>
      _AppStoreSplitManufacturing(this as AppStore).deleteBillOfMaterials(id);

  Future<void> deleteManufacturingOrder(String id) =>
      _AppStoreSplitManufacturing(this as AppStore)
  ...
  Future<ManufacturingOrder> updateManufacturingOrder({
    ...
    String notes = '',
      ...
      _AppStoreSplitManufacturing(this as AppStore).updateManufacturingOrder(
          id: id,
          bomId: bomId,
          quantity: quantity,
  ...
  Future<ManufacturingOrder> startManufacturingOrder({
    ...
    String notes = '',
      ...
      _AppStoreSplitManufacturing(this as AppStore).startManufacturingOrder(
          bomId: bomId,
          quantity: quantity,
          rawMaterialsWarehouseId: rawMaterialsWarehouseId,
          rawMaterialsWarehouseName: rawMaterialsWarehouseName,
  ...
  Future<ManufacturingOrder> finishManufacturingOrder({
    ...
    Map<String, String> wasteReasons = const <String, String>{},
      ...
      _AppStoreSplitManufacturing(this as AppStore).finishManufacturingOrder(
          orderId: orderId,
  ...
  Future<ManufacturingOrder> completeManufacturingOrder({
    ...
    String existingOrderId = '',
      ...
      _AppStoreSplitManufacturing(this as AppStore).completeManufacturingOrder(
          bomId: bomId,
          quantity: quantity,
          rawMaterialsWarehouseId: rawMaterialsWarehouseId,
          rawMaterialsWarehouseName: rawMaterialsWarehouseName,
  ...
  Future<ManufacturingOrder> reverseManufacturingOrder({
    ...
    required String reason,
      ...
      _AppStoreSplitManufacturing(this as AppStore)
          .reverseManufacturingOrder(orderId: orderId, reason: reason);
  ...
  Future<SaleQuotation> createSaleQuotation({
    ...
    DateTime? validUntil,
      ...
      _AppStoreSplitSalesReturns(this as AppStore).createSaleQuotation(
          customerName: customerName,
          customerId: customerId,
          items: items,
          discount: discount,
  ...
  Future<Sale> convertSaleQuotationToSale(
    ...
    String paymentStatus = 'paid',
      ...
      _AppStoreSplitSalesReturns(this as AppStore).convertSaleQuotationToSale(
          quotationId,
          paymentMethod: paymentMethod,
          paymentStatus: paymentStatus);

  Future<void> deleteSaleQuotation(String id) =>
      _AppStoreSplitSalesReturns(this as AppStore).deleteSaleQuotation(id);

  DeliveryNote? deliveryNoteForSale(String saleId) =>
      _AppStoreSplitSalesReturns(this as AppStore).deliveryNoteForSale(saleId);

  Future<DeliveryNote> createDeliveryNoteFromSale(
    String saleId, {
    String note = '',
  }) =>
      _AppStoreSplitSalesReturns(this as AppStore)
          .createDeliveryNoteFromSale(saleId, note: note);

  Future<void> markDeliveryNoteDelivered(String id) =>
      _AppStoreSplitSalesReturns(this as AppStore)
          .markDeliveryNoteDelivered(id);

  Future<void> deleteDeliveryNote(String id) =>
      _AppStoreSplitSalesReturns(this as AppStore).deleteDeliveryNote(id);
  ...
  Future<CreditNote> returnSale(
    ...
    Map<String, double>? returnedQuantities,
      ...
      _AppStoreSplitSalesReturns(this as AppStore).returnSale(id,
          restoreStock: restoreStock, returnedQuantities: returnedQuantities);
  ...
  Future<void> cancelSale(
    ...
    bool restoreStock = true,
      ...
      _AppStoreSplitSalesReturns(this as AppStore)
          .cancelSale(id, status: status, restoreStock: restoreStock);

  @Deprecated(
    'Use cancelSale instead. Invoices are cancelled, not physically deleted.',
  )
  Future<void> deleteSale(String id, {bool restoreStock = true}) =>
      _AppStoreSplitSalesReturns(this as AppStore)
          .deleteSale(id, restoreStock: restoreStock);

  double estimateProfit() =>
      _AppStoreSplitSalesReturns(this as AppStore).estimateProfit();

  Future<void> rebuildProductStockCache(String productId) =>
      _AppStoreSplitBackupRecovery(this as AppStore)
          .rebuildProductStockCache(productId);

  Future<void> rebuildAllProductStockCaches() =>
      _AppStoreSplitBackupRecovery(this as AppStore)
          .rebuildAllProductStockCaches();

  void _applyProductStockCompatibilityDeltas(
    Iterable<StockMovement> movements,
  ) =>
      _AppStoreSplitBackupRecovery(this as AppStore)
          ._applyProductStockCompatibilityDeltas(movements);

  Future<void> _refreshProductStockCompatibilityCache(
    Iterable<String> productIds,
  ) =>
      _AppStoreSplitBackupRecovery(this as AppStore)
          ._refreshProductStockCompatibilityCache(productIds);
  ...
  Map<String, dynamic> unifiedSnapshotPayloadFromChunks(
    List<Map<String, dynamic>> chunks,
      ...
      _AppStoreSplitBackupRecovery(this as AppStore)
          .unifiedSnapshotPayloadFromChunks(chunks);

  Future<List<Map<String, dynamic>>>
      exportDirectLoginBootstrapSnapshotChunks() =>
          _AppStoreSplitBackupRecovery(this as AppStore)
              .exportDirectLoginBootstrapSnapshotChunks();
  ...
  Future<List<Map<String, dynamic>>> exportDirectBootstrapSnapshotChunks({
    ...
    int maxEncodedPayloadBytes = 900 * 1024,
      ...
      _AppStoreSplitBackupRecovery(this as AppStore)
          .exportDirectBootstrapSnapshotChunks(
              maxItemsPerChunk: maxItemsPerChunk,
              maxEncodedPayloadBytes: maxEncodedPayloadBytes);

  String exportRecoveryFileJson({String controlPlaneApiUrl = ''}) =>
      _AppStoreSplitBackupRecovery(this as AppStore)
          .exportRecoveryFileJson(controlPlaneApiUrl: controlPlaneApiUrl);

  Map<String, String> parseRecoveryFileJson(String rawJson) =>
      _AppStoreSplitBackupRecovery(this as AppStore)
          .parseRecoveryFileJson(rawJson);

  Future<String> exportBackupJson() =>
      _AppStoreSplitBackupRecovery(this as AppStore).exportBackupJson();

  String currentHostSnapshotGeneration() =>
      _AppStoreSplitBackupRecovery(this as AppStore)
          .currentHostSnapshotGeneration();

  String currentHostRestoreCommandId() =>
      _AppStoreSplitBackupRecovery(this as AppStore)
          .currentHostRestoreCommandId();
  ...
  Future<Map<String, dynamic>> exportUnifiedSnapshotEnvelope({
    ...
    int maxEncodedPayloadBytes = 900 * 1024,
      ...
      _AppStoreSplitBackupRecovery(this as AppStore)
          .exportUnifiedSnapshotEnvelope(
              kind: kind,
              maxItemsPerChunk: maxItemsPerChunk,
              maxEncodedPayloadBytes: maxEncodedPayloadBytes);

  Future<String> exportSyncSnapshotJson() =>
      _AppStoreSplitBackupRecovery(this as AppStore).exportSyncSnapshotJson();

  DateTime syncSnapshotGeneratedAtFromJson(String rawJson) =>
      _AppStoreSplitBackupRecovery(this as AppStore)
          .syncSnapshotGeneratedAtFromJson(rawJson);

  int syncSnapshotGeneratedSequenceFromJson(String rawJson) =>
      _AppStoreSplitBackupRecovery(this as AppStore)
          .syncSnapshotGeneratedSequenceFromJson(rawJson);
  ...
  String exportSyncChangesJson({
    ...
    int? maxEncodedPayloadBytes,
      ...
      _AppStoreSplitBackupRecovery(this as AppStore).exportSyncChangesJson(
          since: since,
  ...
  List<int> _deriveBackupKeyV2(String password, String salt) =>
      _AppStoreSplitBackupRecovery(this as AppStore)
          ._deriveBackupKeyV2(password, salt);

  String _generateNonce() =>
      _AppStoreSplitBackupRecovery(this as AppStore)._generateNonce();
  ...
  List<int> _aesGcmDecrypt(
    ...
    List<int> nonce,
      ...
      _AppStoreSplitBackupRecovery(this as AppStore)
          ._aesGcmDecrypt(encrypted, key, nonce);

  List<int> _deriveBackupKeyV1(String password, String salt) =>
      _AppStoreSplitBackupRecovery(this as AppStore)
          ._deriveBackupKeyV1(password, salt);

  List<int> _xorWithSha256Stream(
          List<int> input, List<int> key, String nonce) =>
      _AppStoreSplitBackupRecovery(this as AppStore)
          ._xorWithSha256Stream(input, key, nonce);

  bool _constantTimeEquals(List<int> a, List<int> b) =>
      _AppStoreSplitBackupRecovery(this as AppStore)._constantTimeEquals(a, b);

  Future<void> importBackupJson(String rawJson,
          {Set<String>? selectedSectionIds}) =>
      _AppStoreSplitBackupRecovery(this as AppStore)
          .importBackupJson(rawJson, selectedSectionIds: selectedSectionIds);

  int _readVersion(dynamic item) =>
      _AppStoreSplitBackupRecovery(this as AppStore)._readVersion(item);

  DateTime _readUpdatedAt(dynamic item) =>
      _AppStoreSplitBackupRecovery(this as AppStore)._readUpdatedAt(item);

  void _replaceUsersWithoutDuplicates(List<AppUser> incoming) =>
      _AppStoreSplitBackupRecovery(this as AppStore)
          ._replaceUsersWithoutDuplicates(incoming);
  ...
  Future<void> mergeBackupJson(
    ...
    bool markSynced = false,
      ...
      _AppStoreSplitBackupRecovery(this as AppStore)
          .mergeBackupJson(rawJson, markSynced: markSynced);

  Future<void> markAllSyncChangesSynced() =>
      _AppStoreSplitSyncApply(this as AppStore).markAllSyncChangesSynced();

  Future<void> importSyncSnapshotJson(String rawJson) =>
      _AppStoreSplitSyncApply(this as AppStore).importSyncSnapshotJson(rawJson);
  ...
  Future<Map<String, int>> compactSyncedSyncHistoryForDiagnostics({
    int keepRecentSyncedChanges = AppStore._syncMaintenanceKeepRecentChanges,
      ...
      _AppStoreSplitSyncApply(this as AppStore)
          .compactSyncedSyncHistoryForDiagnostics(
              keepRecentSyncedChanges: keepRecentSyncedChanges);

  Future<Map<String, int>> compactSyncedSyncHistoryForMaintenance({
    int keepRecentSyncedChanges = AppStore._syncMaintenanceKeepRecentChanges,
    int minChangesBeforeCompact =
        AppStore._syncMaintenanceMinChangesBeforeCompact,
  }) =>
      _AppStoreSplitSyncApply(this as AppStore)
          .compactSyncedSyncHistoryForMaintenance(
              keepRecentSyncedChanges: keepRecentSyncedChanges,
              minChangesBeforeCompact: minChangesBeforeCompact);
  ...
  Future<Map<String, int>> compactClientSyncedSyncHistoryForMaintenance({
    int keepRecentSyncedChanges = AppStore._syncMaintenanceKeepRecentChanges,
      ...
      _AppStoreSplitSyncApply(this as AppStore)
          .compactClientSyncedSyncHistoryForMaintenance(
              keepRecentSyncedChanges: keepRecentSyncedChanges);
  ...
  Future<void> applyRemoteSyncChanges(
    ...
    bool mirrorToDirect = false,
      ...
      _AppStoreSplitSyncApply(this as AppStore).applyRemoteSyncChanges(incoming,
          markAppliedAsSynced: markAppliedAsSynced,
          mirrorToDirect: mirrorToDirect);

  List<DataConflict> _detectDataConflicts() =>
      _AppStoreSplitSyncApply(this as AppStore)._detectDataConflicts();

  Future<void> assertRemoteSyncChangesApplied(List<SyncChange> changes) =>
      _AppStoreSplitSyncApply(this as AppStore)
          .assertRemoteSyncChangesApplied(changes);

  Future<void> markSyncChangesSubmittedByIds(Iterable<String> ids) =>
      _AppStoreSplitSyncApply(this as AppStore)
          .markSyncChangesSubmittedByIds(ids);

  Future<void> markSyncChangesSyncedByIds(Iterable<String> ids) =>
      _AppStoreSplitSyncApply(this as AppStore).markSyncChangesSyncedByIds(ids);
  ...
  Future<void> settleLegacyLanHostQueue() =>
      _AppStoreSplitSyncApply(this as AppStore).settleLegacyLanHostQueue();
  ...
  Future<int> settleHostQueueThroughPeerAck() =>
      _AppStoreSplitSyncApply(this as AppStore).settleHostQueueThroughPeerAck();

  Future<void> markSyncQueueChangesInProgress(
    Iterable<String> changeIds,
  ) =>
      _AppStoreSplitSyncApply(this as AppStore)
          .markSyncQueueChangesInProgress(changeIds);

  Future<void> markSyncChangesRejectedByIds(
    Map<String, String> rejected,
  ) =>
      _AppStoreSplitSyncApply(this as AppStore)
          .markSyncChangesRejectedByIds(rejected);
  ...
  Future<void> markSyncQueueChangesFailed(
    ...
    String error,
      ...
      _AppStoreSplitSyncApply(this as AppStore)
          .markSyncQueueChangesFailed(changeIds, error);

  Future<void> retryFailedSyncQueue({String? target}) =>
      _AppStoreSplitSyncApply(this as AppStore)
          .retryFailedSyncQueue(target: target);

  Future<void> recoverStaleInProgressSyncQueue({
    String? target,
    Duration staleAfter = const Duration(seconds: 45),
  }) =>
      _AppStoreSplitSyncApply(this as AppStore).recoverStaleInProgressSyncQueue(
          target: target, staleAfter: staleAfter);

  Future<void> recoverSubmittedSyncQueue({String? target}) =>
      _AppStoreSplitSyncApply(this as AppStore)
          .recoverSubmittedSyncQueue(target: target);

  Future<void> markSyncQueueItemFailed(String queueItemId, String error) =>
      _AppStoreSplitSyncApply(this as AppStore)
          .markSyncQueueItemFailed(queueItemId, error);
  ...
  Future<void> prepareForShutdown() =>
      _AppStoreSplitSyncApply(this as AppStore).prepareForShutdown();
}
