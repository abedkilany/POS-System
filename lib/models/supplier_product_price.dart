class SupplierProductPriceHistoryEntry {
  ...
  factory SupplierProductPriceHistoryEntry.fromJson(
          Map<String, dynamic> json) =>
      SupplierProductPriceHistoryEntry(
        oldCost: _toDouble(json['oldCost']),
        newCost: _toDouble(json['newCost']),
        currency:
            json['currency']?.toString().toUpperCase() == 'LBP' ? 'LBP' : 'USD',
...
class SupplierProductPrice {
  ...
  factory SupplierProductPrice.fromJson(Map<String, dynamic> json) {
    ...
    final history = rawHistory is List
        ? rawHistory
            .whereType<Map>()
            .map((item) => SupplierProductPriceHistoryEntry.fromJson(
    ...
    return SupplierProductPrice(
      ...
      currency:
          (json['currency']?.toString().toUpperCase() == 'LBP') ? 'LBP' : 'USD',
      isPreferred:
          json['isPreferred'] == true || json['preferredSupplier'] == true,
      supplierSku: json['supplierSku']?.toString() ??
          json['supplierSKU']?.toString() ??
          json['supplierCode']?.toString() ??
          '',
      minOrderQty:
          _toOptionalDouble(json['minOrderQty'] ?? json['minimumOrderQty']),
      leadTimeDays:
          _toOptionalInt(json['leadTimeDays'] ?? json['lead_time_days']),
