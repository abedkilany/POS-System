class Product {
  ...
  Product copyWith({String? id, String? name, String? code, String? nameEn, String? nameAr, double? price, double? cost, int? stock, String? category, double? originalPrice, String? originalCurrency, double? usdPrice, double? exchangeRateAtEntry, String? barcode, String? brand, String? supplier, String? description, String? unit, int? lowStockThreshold, bool? trackStock, bool? isActive, DateTime? createdAt, DateTime? updatedAt, DateTime? deletedAt, bool clearDeletedAt = false, String? deviceId, String? syncStatus, String? storeId, String? branchId, int? version, String? lastModifiedByDeviceId}) => Product(
    id: id ?? this.id, name: name ?? this.name, code: code ?? this.code, nameEn: nameEn ?? this.nameEn, nameAr: nameAr ?? this.nameAr, price: price ?? this.price, cost: cost ?? this.cost, stock: stock ?? this.stock, category: category ?? this.category, originalPrice: originalPrice ?? this.originalPrice, originalCurrency: originalCurrency ?? this.originalCurrency, usdPrice: usdPrice ?? this.usdPrice, exchangeRateAtEntry: exchangeRateAtEntry ?? this.exchangeRateAtEntry, barcode: barcode ?? this.barcode, brand: brand ?? this.brand, supplier: supplier ?? this.supplier, description: description ?? this.description, unit: unit ?? this.unit, lowStockThreshold: lowStockThreshold ?? this.lowStockThreshold, trackStock: trackStock ?? this.trackStock, isActive: isActive ?? this.isActive, createdAt: createdAt ?? this.createdAt, updatedAt: updatedAt ?? this.updatedAt, deletedAt: clearDeletedAt ? null : (deletedAt ?? this.deletedAt), deviceId: deviceId ?? this.deviceId, syncStatus: syncStatus ?? this.syncStatus, storeId: storeId ?? this.storeId, branchId: branchId ?? this.branchId, version: version ?? this.version, lastModifiedByDeviceId: lastModifiedByDeviceId ?? this.lastModifiedByDeviceId);

  Map<String, dynamic> toJson() => {'id': id, 'name': name, 'code': code, 'nameEn': nameEn, 'nameAr': nameAr, 'price': price, 'cost': cost, 'originalPrice': originalPrice, 'originalCurrency': originalCurrency, 'usdPrice': usdPrice, 'exchangeRateAtEntry': exchangeRateAtEntry, 'stock': stock, 'category': category, 'barcode': barcode, 'brand': brand, 'supplier': supplier, 'description': description, 'unit': unit, 'lowStockThreshold': lowStockThreshold, 'trackStock': trackStock, 'isActive': isActive, 'createdAt': createdAt.toIso8601String(), 'updatedAt': updatedAt.toIso8601String(), 'deletedAt': deletedAt?.toIso8601String(), 'deviceId': deviceId, 'syncStatus': syncStatus, 'storeId': storeId, 'branchId': branchId, 'version': version, 'lastModifiedByDeviceId': lastModifiedByDeviceId};
