...
class SaleQuotation {
  ...
  bool get isConverted =>
      status.toLowerCase() == 'converted' || convertedSaleId.trim().isNotEmpty;
  double get subtotal =>
  ...
  factory SaleQuotation.fromJson(Map<String, dynamic> json) {
    ...
    return SaleQuotation(
      ...
      quotationNo:
          json['quotationNo'] as String? ?? json['quoteNo'] as String? ?? '',
      ...
      invoiceCurrency:
          ((json['invoiceCurrency'] as String? ?? 'USD').toUpperCase() == 'LBP')
              ? 'LBP'
              : 'USD',
