...
extension ProductPriceOverrideModeJson on ProductPriceOverrideMode {
  String get code =>
      this == ProductPriceOverrideMode.manual ? 'manual' : 'fixed';

  static ProductPriceOverrideMode fromCode(String? value) {
    return value == 'manual'
        ? ProductPriceOverrideMode.manual
        : ProductPriceOverrideMode.fixed;
  }
}
...
class ProductPrice {
  ...
  ProductPrice copyWith(
      ...
      ProductPrice(
        ...
        baseCurrencyCode:
            (baseCurrencyCode ?? this.baseCurrencyCode).toUpperCase(),
  ...
  factory ProductPrice.fromJson(Map<String, dynamic> json) {
    ...
    return ProductPrice(
      ...
      baseCurrencyCode:
          (json['baseCurrencyCode'] as String? ?? 'USD').toUpperCase(),
...
class ProductPriceOverride {
  ...
  ProductPriceOverride copyWith(
          {String? id,
          String? productPriceId,
          String? currencyCode,
          double? amount,
          ProductPriceOverrideMode? mode,
          bool? isActive,
          DateTime? createdAt,
          DateTime? updatedAt}) =>
      ProductPriceOverride(
