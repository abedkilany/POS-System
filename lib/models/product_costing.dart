enum InventoryCostingMethod { weightedAverage, fifo, lastPurchaseCost, batch }
...
class CostingMethodHistory {
  ...
  factory CostingMethodHistory.fromJson(Map<String, dynamic> json) {
    ...
    return CostingMethodHistory(
      ...
      effectiveFrom:
          DateTime.tryParse(json['effectiveFrom'] as String? ?? '') ?? updated,
