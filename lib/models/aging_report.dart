...
class AgingReportResult {
  ...
  double get days1To30 =>
      rows.fold<double>(0, (sum, row) => sum + row.days1To30);
  double get days31To60 =>
      rows.fold<double>(0, (sum, row) => sum + row.days31To60);
  double get days61To90 =>
      rows.fold<double>(0, (sum, row) => sum + row.days61To90);
