class PaymentAllocation {
  PaymentAllocation({
    ...
    this.exchangeRate = 1,
    this.status = 'active',
    this.allocationKind = 'allocation',
    this.reversalOfId = '',
    this.reversalReason = '',
    this.reversedBy = '',
  ...
  final double
      referenceAmount; // amount applied to the target document currency
  final String currency;
  final String referenceCurrency;
  final double exchangeRate;
  final String status, reversalReason, reversedBy, reversedByUserId;
  final String allocationKind, reversalOfId;
  ...
  double get effectiveReferenceAmount =>
      referenceAmount > 0 ? referenceAmount : amount;
  ...
  factory PaymentAllocation.fromJson(Map<String, dynamic> json) {
    ...
    return PaymentAllocation(
      ...
      exchangeRate:
          value(json['exchangeRate']) <= 0 ? 1 : value(json['exchangeRate']),
      status: json['status']?.toString() ?? 'active',
      allocationKind: json['allocationKind']?.toString() ?? 'allocation',
