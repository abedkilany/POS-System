      ...
      pw.MultiPage(
        ...
        header: (context) => context.pageNumber == 1
            ...
            : ProfessionalPdfTheme.compactHeader(
                profile: profile, title: labels.transferOrder),
        ...
        build: (_) => [
          ProfessionalPdfTheme.infoStrip(
            ...
            entries: [
              ...
              if (order.createdByUserName.trim().isNotEmpty)
                MapEntry(labels.createdBy, order.createdByUserName.trim()),
            ],
          ),
          ...
          ProfessionalPdfTheme.summaryBox(
            ...
            rows: [
              MapEntry(labels.products, '${order.items.length}'),
              MapEntry(
                  labels.totalBaseUnits, _formatQuantity(order.totalUnits)),
            ],
          ),
