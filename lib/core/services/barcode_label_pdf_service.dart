...
class BarcodeLabelPdfService {
  ...
  static pw.Widget _label(
    ...
    final barcodeType =
        _isValidEan13(barcode) ? pw.Barcode.ean13() : pw.Barcode.code128();
    ...
    final priceCurrency =
        effectiveCurrency.isEmpty ? profile.currency : effectiveCurrency;
    ...
    final priceWithCurrency =
        currencySymbol.isEmpty ? priceText : '$priceText $currencySymbol';
                    ...
                    pw.Center(
                      child: pw.Directionality(
                        ...
                        child: pw.BarcodeWidget(
                          ...
                          height: barcodePanelHeight - (1.3 * PdfPageFormat.mm),
                          drawText: true,
