...
class WarehouseInventoryPdfService {
  static Future<Uint8List> buildWarehouseInventoryPdf({
    ...
    final printableRows =
        rows.where((row) => row.stock.abs() > 0.000001).toList(growable: false);
      ...
      pw.MultiPage(
        ...
        header: (context) => context.pageNumber == 1
            ...
            : ProfessionalPdfTheme.compactHeader(
                profile: profile, title: labels.inventoryReport),
          ...
          ProfessionalPdfTheme.infoStrip(
            ...
            entries: [
              ...
              if (warehouse.code.trim().isNotEmpty)
                MapEntry(labels.code, warehouse.code.trim()),
              if (warehouse.location.trim().isNotEmpty)
                MapEntry(labels.location, warehouse.location.trim()),
            ],
          ),
