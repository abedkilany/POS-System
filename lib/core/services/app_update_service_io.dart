...
class AppUpdateService {
  ...
  Future<AppUpdateInfo?> checkForUpdate() async {
    ...
    try {
      ...
      final latest =
          update.isNewerThan(AppBrand.versionName, AppBrand.buildNumber)
              ? update
              : null;
      final restoredPath =
          latest == null ? null : await getDownloadedInstallerPath(update);
      status.value = status.value.copyWith(
        latest: latest,
        ...
        downloading: false,
        installing: false,
        downloadProgress: latest == null || restoredPath == null
            ? null
            : status.value.downloadProgress,
