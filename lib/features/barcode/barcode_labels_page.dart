...
class _BarcodePrintOptionsDialogState
  ...
  Widget build(BuildContext context) {
    final tr = AppLocalizations.of(context);
    return AlertDialog(
      title: Text(tr.text('barcode_print_settings')),
      content: SizedBox(
        width: 420,
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: ListView(
                children: [
                  Text(tr.text('barcode_label_size')),
                  ...
                  TextField(
                    ...
                    onChanged: (_) => setState(() {}),
                    decoration: InputDecoration(
                      labelText: tr.text('barcode_weight_and_price'),
                      hintText: tr.text('barcode_weight_and_price_hint'),
                      isDense: true,
                    ),
                  ),
                  ...
                  SwitchListTile(
                    ...
                    dense: true,
                    title: Text(tr.text('barcode_show_price')),
                    value: showPrice,
                    onChanged: (value) => setState(() => showPrice = value),
                  ),
                  const SizedBox(height: 8),
                  Text(tr.text('barcode_safe_margins_desc')),
                  const SizedBox(height: 8),
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: [
                      ...
                      DropdownMenuItem(
                          value: 'weight',
                          child: Text(tr.text('barcode_weight_and_price'))),
                      DropdownMenuItem(
                          value: 'dates',
