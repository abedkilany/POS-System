                      ...
                      LayoutBuilder(
                        builder: (context, constraints) {
                          ...
                          return ListTile(
                            ...
                            trailing: ConstrainedBox(constraints: BoxConstraints(maxWidth: VentioResponsive.clampToScreen(context, 360, min: 180, horizontalPadding: 120)), child: Align(alignment: Alignment.centerRight, child: meta)),
                          );
                        },
                      ),
                      const Divider(height: 1),
