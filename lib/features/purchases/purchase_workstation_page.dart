...
class _PurchaseWorkstationPageState extends State<PurchaseWorkstationPage> {
  ...
  Future<void> _savePurchase() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text(tr.text('purchase_saved'))));
    } catch (error) {
      if (mounted) {
        ScaffoldMessenger.of(context)
          ...
          Padding(
              ...
              child: Column(children: [
                ...
                SegmentedButton<String>(
                    segments: [
                      ButtonSegment(
                          value: 'paid', label: Text(tr.text('paid'))),
                      ButtonSegment(
                          value: 'credit', label: Text(tr.text('credit')))
                    ],
                    selected: {
                      _paymentStatus
                    },
