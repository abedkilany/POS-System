                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Wrap(
                        ...
                        children: [
                          SizedBox(
                            width: VentioResponsive.clampToScreen(context, 260, min: 180, horizontalPadding: 56),
                          ...
                          SizedBox(width: VentioResponsive.adaptiveWidth(context, mobile: 92, tablet: 104, desktop: 110), child: TextFormField(controller: qtyController, decoration: InputDecoration(labelText: tr.text('quantity')), keyboardType: TextInputType.number)),
                          SizedBox(width: VentioResponsive.adaptiveWidth(context, mobile: 104, tablet: 122, desktop: 130), child: TextFormField(controller: costController, decoration: InputDecoration(labelText: tr.text('unit_cost')), keyboardType: const TextInputType.numberWithOptions(decimal: true))),
                          OutlinedButton.icon(
