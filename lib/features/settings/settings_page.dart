...
_SyncStatusView _connectionStatusForHostPeer(BuildContext context,
    {required HostPeerSyncState? state,
    required CloudDeviceStatus? cloudDevice,
    required bool suspended,
...
_SyncStatusView _connectionStatusForClient(BuildContext context,
...
String _activeTransportForHostPeer(BuildContext context,
    {required bool lanAuthorized,
    required CloudDeviceStatus? cloudDevice,
    required HostPeerSyncState? state}) {
  final tr = AppLocalizations.of(context);
...
_SyncStatusView _syncStatusForHostPeer(
    BuildContext context, HostPeerSyncState? state,
    {required bool lanAuthorized,
    required CloudDeviceStatus? cloudDevice,
    required bool suspended,
    bool wipePending = false}) {
  ...
  if (age <= const Duration(hours: 2)) {
    return _SyncStatusView(
        label: tr.text('sync_delayed'),
        color: Colors.orange,
        icon: Icons.schedule_outlined);
  }
  return _SyncStatusView(
      label: tr.text('needs_attention'),
      color: Theme.of(context).colorScheme.error,
      icon: Icons.warning_amber_outlined);
}

String _deviceLabel(String deviceId,
    {HostRegistryDevice? registryDevice, CloudDeviceStatus? cloudDevice}) {
...
_SyncStatusView _syncStatusForClient(
    BuildContext context, SyncDeviceState state,
