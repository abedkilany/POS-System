...
Future<Map<String, Object?>> _computeSnapshotFromStore(
  ...
  try {
    ...
    todayCashIn = cashSummary.cashIn;
    todayCashOut = cashSummary.cashOut;
  } catch (_) {
    // Cash remains zero rather than falling back to customer/supplier movements.
  }
  ...
  try {
    ...
    // Financial profit remains zero rather than using an operational estimate.
  }
