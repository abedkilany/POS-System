  ...
  Future<Map<String, Object?>> _computeAndCacheSummary(
    ...
    if (store.isHeavyDataLoaded) {
      final computed = await StartupTimingService.measure(
        'reports.snapshot_memory_summary',
...
Map<String, Object?> _computeSnapshot(Map<String, Object?> input) {
  ...
  final today = DateTime(reference.year, reference.month, reference.day);
  final products = _decodeList(
    input['productsJson'].toString(),
    Product.fromJson,
  );
  final sales = _decodeList(
    input['salesJson'].toString(),
    Sale.fromJson,
  );
  final purchases = _decodeList(
    input['purchasesJson'].toString(),
    Purchase.fromJson,
  );
  final expenses = _decodeList(
    input['expensesJson'].toString(),
    Expense.fromJson,
  );
  final stockMovements = _decodeList(
    input['stockMovementsJson'].toString(),
    StockMovement.fromJson,
  );
  final accountTransactions = _decodeList(
    input['accountTransactionsJson'].toString(),
    AccountTransaction.fromJson,
  );
  final customers = _decodeList(
    input['customersJson'].toString(),
    Customer.fromJson,
  );
  final suppliers = _decodeList(
    input['suppliersJson'].toString(),
    Supplier.fromJson,
  );
