...
class _DiagnosticsPageState extends State<DiagnosticsPage>
  ...
  Future<void> _verifyAuditIntegrity() async {
    final tr = AppLocalizations.of(context);
      ...
      SnackBar(
        content: Text(
          result.ok
              ? tr.format(
                  'audit_integrity_ok',
                  {'count': result.checkedRows},
                )
              : tr.format(
                  'audit_integrity_failed',
                  {
                    'count': result.checkedRows,
                    'id': result.firstInvalidId,
                  },
                ),
        ),
      ),
          ...
          Padding(
            ...
            child: Wrap(
              ...
              children: [
                ...
                OutlinedButton.icon(
                  onPressed: _loading ? null : _verifyAuditIntegrity,
                  icon: const Icon(Icons.verified_user_outlined),
                  label: Text(tr.text('verify_audit_integrity')),
                ),
              ],
            ),
          ),
