          ...
          children: [
            ...
            SummaryCard(
                ...
                value: formatUsdReferenceAmount(
                    store.totalExpensesAmount, store.storeProfile),
                icon: Icons.money_off_csred_outlined),
            SummaryCard(
                title: tr.text('net_profit'),
                value: formatUsdReferenceAmount(
                    store.estimateProfit(), store.storeProfile),
            ...
            final snapshotPanel = Card(
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(tr.text('business_snapshot'),
                        style: Theme.of(context).textTheme.titleLarge),
                    const SizedBox(height: 12),
                    _Line(
                    ...
                    _Line(
                        ...
                        value: formatUsdReferenceAmount(
                            store.inventoryCostValue, store.storeProfile)),
                    _Line(
