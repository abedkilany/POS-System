          ...
          builder: (context, setDialogState) {
            Future<void> submit() async {
              ...
              final locallyAuthorized =
                  await widget.store.security.authorizeSensitiveAction(
                action: SensitiveAction.storeOwnerCredentials,
              ...
              if (!locallyAuthorized) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text(tr.text('wrong_password'))),
                );
                return;
              }
    ...
    return Column(
      ...
      children: [
        ...
        SyncMonitoringSection(
          store: widget.store,
          forceHostView: true,
          storeIdOverride: cache.storeId,
          branchIdOverride: cache.branchId,
        ),
      ],
    );
  }
