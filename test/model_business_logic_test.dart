...
void main() {
  ...
  group('Sale and sale item calculations', () {
    ...
    test('deserializes legacy sale item cost aliases', () {
      ...
      final snakeCase = SaleItem.fromJson({
        'productId': 'p2',
        'productName': 'Legacy 2',
        'unitPrice': 9,
        'quantity': 2,
        'unit_cost': 4
      });
  ...
  group('Purchase calculations', () {
    ...
    test('calculates purchase subtotal and unit count', () {
      final purchase = Purchase(
        ...
        items: const [
          PurchaseItem(
              productId: 'p1', productName: 'Beans', quantity: 5, unitCost: 8),
          PurchaseItem(
              productId: 'p2', productName: 'Milk', quantity: 3, unitCost: 2),
        ],
      );
  ...
  group('Stock movement value', () {
    test('uses absolute quantity for stock value', () {
      final saleMovement = StockMovement(
          ...
          date: DateTime(2026),
          unitCost: 4);
      final receiveMovement =
          saleMovement.copyWith(type: 'purchase_receive', quantity: 3);
  ...
  group('Catalog and profile helpers', () {
    test('chooses Arabic display name with English fallback', () {
      final item =
          CatalogItem(id: 'cat1', nameEn: 'Beverages', nameAr: 'مشروبات');
