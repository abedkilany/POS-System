  ...
  group('Reusable widget smoke tests', () {
    testWidgets('AppSectionHeader renders title and subtitle', (tester) async {
      await tester.pumpWidget(wrap(
          const AppSectionHeader(title: 'Inventory', subtitle: 'Track stock')));
      expect(find.text('Inventory'), findsOneWidget);
      expect(find.text('Track stock'), findsOneWidget);
    });

    testWidgets('EmptyStateCard renders icon, title, and message',
        (tester) async {
      await tester.pumpWidget(wrap(const EmptyStateCard(
    ...
    testWidgets('SummaryCard renders label and value', (tester) async {
      await tester.pumpWidget(wrap(const SummaryCard(
          title: 'Sales', value: r'$120.00', icon: Icons.receipt_long)));
    ...
    testWidgets('ReportCard renders label and value', (tester) async {
      await tester.pumpWidget(
          wrap(const ReportCard(title: 'Gross Profit', subtitle: r'$55.00')));
