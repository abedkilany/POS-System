...
void main() {
  group('SQLite business query layer', () {
    ...
    test('queries products with search, category, and pagination', () async {
      ...
      // Text-search pages intentionally expose a bounded "at least" count to
      // avoid a full COUNT scan before rendering the first page.
      expect(firstPage.totalCount, 4);
      expect(secondPage.totalCount, 6);
