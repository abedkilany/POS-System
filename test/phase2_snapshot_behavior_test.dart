  ...
  group('Phase 2 snapshot behavior', () {
    test(
      ...
      () async {
        ...
        final sourceChunks = await store.exportUnifiedSnapshotChunks(
          sectionIds: {
            UnifiedSnapshotCatalog.productsCustomersSuppliers.id,
            UnifiedSnapshotCatalog.inventoryMovements.id,
          },
        );
    ...
    test(
      ...
      () async {
        ...
        legacyPayload.remove('inventoryBatches');
        legacyPayload.remove('inventoryBatchBalances');
        legacyPayload.remove('inventory_batches');
        legacyPayload.remove('inventory_batch_balances');
